...
#
# Builds all docker images for a certain architecture and uploads them onto a remote machine.
# Afterwards it loads the images and launches them using the docker-compose.yml.
#
...
echo ""
echo "################################################"
echo "Launching remote dockerized deployment."
echo "################################################"
echo ""
